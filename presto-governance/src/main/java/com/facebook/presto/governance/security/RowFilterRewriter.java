...
public class RowFilterRewriter
        extends ConnectorPlanRewriter<GovernanceConnectorAccessControl.RowFilterData>
{
    ...
    @Override
    public PlanNode visitFilter(FilterNode filter, RewriteContext<GovernanceConnectorAccessControl.RowFilterData> context)
    {
