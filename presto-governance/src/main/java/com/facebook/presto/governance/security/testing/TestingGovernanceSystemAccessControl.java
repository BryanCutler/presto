...
import com.facebook.presto.governance.security.GovernanceSystemAccessControl;
...
public class TestingGovernanceSystemAccessControl
    implements GovernanceSystemAccessControl
{
    public static final String NAME = "governance";

    private static final TestingGovernanceSystemAccessControl INSTANCE = new TestingGovernanceSystemAccessControl();
