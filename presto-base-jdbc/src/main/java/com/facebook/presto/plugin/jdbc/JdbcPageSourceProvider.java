        ...
        implements ConnectorPageSourceProvider
{
    ...
    @Inject
    public JdbcPageSourceProvider(JdbcClient jdbcClient, JdbcRecordSetProvider jdbcRecordSetProvider)
    {
    ...
    {
        return new RecordPageSource(jdbcRecordSetProvider.getRecordSet(transactionHandle, session, split, columns));
    }
