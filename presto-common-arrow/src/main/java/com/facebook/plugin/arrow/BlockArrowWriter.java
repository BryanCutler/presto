...
public class BlockArrowWriter
{
    ...
    private static class ArrowTimeWriter
            extends ArrowVectorWriter
    {
        protected final TimeMilliVector vector;
        protected final BlockValueGetter blockGetter;
        ...
        public void writeBlock(int index, Block block, int position)
        {
            // Value is elapsed time since midnight
            vector.set(index, (int) blockGetter.getLong(block, position));
        }
    }

    private static class ArrowTimeWithTimeZoneWriter
            extends ArrowTimeWriter
    {
        public ArrowTimeWithTimeZoneWriter(TimeMilliVector vector, BlockValueGetter blockGetter)
        {
            super(vector, blockGetter);
        }
        @Override
        public void writeBlock(int index, Block block, int position)
        {
            long value = blockGetter.getLong(block, position);
            vector.set(index, (int) unpackMillisUtc(value));
        }
    }
    ...
    private static class ArrowTimeStampWriter
            extends ArrowVectorWriter
    {
        protected final TimeStampVector vector;
        protected final BlockValueGetter blockGetter;
    ...
    private static class ArrowTimeStampWithTimeZoneWriter
            extends ArrowTimeStampWriter
    {
        public ArrowTimeStampWithTimeZoneWriter(TimeStampVector vector, BlockValueGetter blockGetter)
        {
            super(vector, blockGetter);
        }
        ...
        {
            long value = blockGetter.getLong(block, position);
            vector.set(index, unpackMillisUtc(value));
        }
    }
